      ...
      {(context) => (
        ...
        >
          ...
          >
            ...
            >
              <FacebookIcon size={context === DeviceType.isDesktopOrLaptop ? 64 : 32} round />
            </IconButton>
          </div>
          <div style={{
            display: 'flex', flexDirection: 'column', justifyContent: 'end',
          ...
          >
            ...
            >
              <WhatsappIcon size={context === DeviceType.isDesktopOrLaptop ? 64 : 32} round />
            </IconButton>
            <IconButton
              target="_blank"
            ...
            >
              <EmailIcon size={context === DeviceType.isDesktopOrLaptop ? 64 : 32} round />
            </IconButton>
            <IconButton
              className="pointerOverEffect"
              target="_blank"
            ...
            >
              <FacebookMessengerIcon
                size={context === DeviceType.isDesktopOrLaptop ? 64 : 32}
                round
              />
            </IconButton>
          </div>
